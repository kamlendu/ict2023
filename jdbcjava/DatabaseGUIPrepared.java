/*
In ubuntu we get some corba iiop warning if we use open jdk given by ubuntu, Instead use java 6 given by sun using following commands. see that jdk is installed
